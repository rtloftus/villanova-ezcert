...
INSERT INTO students (
    ...
    minor5, minor6, minor7, minor8, conc1, conc2, conc3, conc4, conc5, conc6, conc7,
    conc8, overall_hours, core_humanities, core_philosophy, core_ethics, core_math,
    core_nat_sci, core_lit, core_history, core_soc_sci, core_fine_arts, core_theology,
    core_language, core_diversity, first_major, free_electives, total, status,
    review_status, notes, missing_requirements, audit_file
)
VALUES (
    @unique_id, @vuid, @last_name, @first_name, @clas, @catalog_term, @exp_grad_date,
    @program, @dept, @major1, @major2, @major3, @major4, @minor1, @minor2, @minor3, @minor4,
    @minor5, @minor6, @minor7, @minor8, @conc1, @conc2, @conc3, @conc4, @conc5, @conc6,
    @conc7, @conc8, @overall_hours, @core_humanities, @core_philosophy, @core_ethics,
    @core_math, @core_nat_sci, @core_lit, @core_history, @core_soc_sci,
